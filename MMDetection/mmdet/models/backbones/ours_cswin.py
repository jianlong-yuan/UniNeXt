...
class CSWinBlock(nn.Module):
    ...
    def forward(self, x, Hm, Wm):
        ...
        x = x + self.drop_path(self.mlp(self.norm2(x),Hm, Wm))
...
class ours_cswin(BaseModule):
    ...
    def __init__(self, 
                 ...
                 use_chk=False,
                 init_cfg=None):
        super(ours_cswin, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        ...
        if (isinstance(self.init_cfg, dict)
            ...
            super(ours_cswin, self).init_weights()
        else:
            def _init_weights(m):
