...
model = dict(
    backbone=dict(
        init_cfg=dict(type='Pretrained', checkpoint='/mnt/workspace/linfangjian.lfj/mmsegmentation/vis_swin_upernet/upernet_swin_large_patch4_window7_512x512_pretrain_224x224_22K_160k_ade20k_20220318_015320-48d180dd.pth'),
