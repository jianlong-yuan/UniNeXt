...
class ablation_dwmlp(BaseModule):
    ...
    def __init__(self, 
                 ...
                 use_chk=False,
                 init_cfg=None):
        super(ablation_dwmlp, self).__init__(init_cfg=init_cfg)
    ...
    def init_weights(self):
        ...
        if (isinstance(self.init_cfg, dict)
            ...
            super(ablation_dwmlp, self).init_weights()
        else:
            def _init_weights(m):
    ...
    def forward(self, x):
        ...
        H_i, W_i = H1, W1
        for pre, blocks, ln in zip([self.merge1, self.merge2, self.merge3],
