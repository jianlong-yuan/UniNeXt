...
#ws    7  7  7  7
#wd    3  3  3  3
    model = DilatedFormer_Windows(patch_size=4, embed_dim=96, depth=[2,2,18,2],
        ws = [7,7,7,7], wd=[3,3,3,3], num_heads=[3,6,12,24], mlp_ratio=4., **kwargs)
    model.default_cfg = default_cfgs['DilatedFormer_224']
    return model
...
#ws    7  7  7  7
#wd    3  3  3  3
    model = DilatedFormer_Windows(patch_size=4, embed_dim=128, depth=[2,2,18,2],
        ws = [7,7,7,7], wd=[3,3,3,3], num_heads=[4,8,16,32], mlp_ratio=4., **kwargs)
    model.default_cfg = default_cfgs['DilatedFormer_224']
    return model
